...
export default function Sidebar() {
    return (
        <div className='sidebar'>
            <div className="d-flex flex-column flex-shrink-0 p-3" style={{ width: '280px' ,minHeight: '100vh'}}>
                ...
                <ul className="nav nav-pills flex-column mb-auto">
                    <li className="nav-item">
                        <a href="/" className="nav-link active" aria-current="page" style={{backgroundColor:"rgb(40, 76, 121)"}}>
